...
class HomePromoKhusus extends StatefulWidget {
  HomePromoKhusus(
  ...
  @override
  State<HomePromoKhusus> createState() => _HomePromoKhususState();
}

class _HomePromoKhususState extends State<HomePromoKhusus> {
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<Map<String, dynamic>>>(
      future: widget.futurePromoKhusus,
